...
if: IF '(' lo ')' THEN '{'s'}' {if($3==0)
				printf("if not excuted \n");
			        else 
				printf("if is excuted \n");
				}

 | IF '('lo ')' THEN '{' s'}' ELSE '{'s'}' {if($3==0)
